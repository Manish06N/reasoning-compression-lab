...
**Decoding profiles (historical; recovery plan controls new paper runs):**
...
The old seed-0 cell names are not evidence that seed 0 is the publication protocol. New pilot aggregates use seeds 42/43/44; headline MATH-500 cells use 42–46.

### Audited FP8 artifact pins

| Model | Artifact revision | A100 execution qualification |
|-------|-------------------|------------------------------|
| Qwen-7B FP8 | `ceb2fcd178d477cd21b92ffb43164c74165a212c` | weight-only Marlin fallback |
| Llama-8B FP8 | `5d548d9169c53b7bb7ef0b3bc261509d5da6e3dd` | weight-only Marlin fallback |

Record exact revisions for BF16/AWQ4/GPTQ4 before matched execution.
