...
\midrule
This paper & 2 R1 distill (7B/8B) & BF16, FP8, AWQ-4, GPTQ-4 & vLLM 0.7.0 eager, A100 & 5 MATH; 3 GSM/GPQA & RoM, paired $\Delta$, both conditionals, seed placebo & $2\times 2$ + both mirrors & GPU-s; campaign-length seconds & item-level bootstrap, Holm, TOST \\
...
Lian et al.~\cite{lian2026quantinflates} & reasoning PTQ & low-bit PTQ & paper stack & paper-specific & CTIR (ratio of means); BF16-correct split (suppl.) & BF16-correct vs rest (suppl.) & token cost & length ratio \\
