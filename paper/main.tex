...
(C5)~Cost-estimator and serving-condition sensitivity: rankings from the historical $65$ tok/s token proxy, sequential Condition~A, and batched Condition~B aggregate hybrid Cost-of-Pass proxies do not agree; Conditions~A and~B differ jointly in workload subset and serving regime. The released grid and analysis artifacts support reproducibility of these contributions.
