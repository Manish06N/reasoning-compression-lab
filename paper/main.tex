...
(C2)~\textbf{Ranking instability.} The same checkpoints receive different rankings depending on accuracy, maj@5, correctness-conditioned length, the historical token proxy, sequential GPU-seconds, and batched GPU-seconds.
...
\textbf{Manish Nandish:} Conceptualization, Methodology, Software, Investigation, Data curation, Formal analysis, Visualization, Writing -- original draft.
\textbf{Rajiv Misra:} Supervision, Resources, Writing -- review \& editing.
