...
| Modal-answer selective prediction | **Not yet available** (no extracted answers in compact JSON) |
...
Per-cell records: `results/math500/`, `results/gsm8k/`, `results/gpqa/`. Canonical report: `results/reports/revision_reanalysis_report.json`. Packaging: [`ARTIFACT.md`](ARTIFACT.md).
