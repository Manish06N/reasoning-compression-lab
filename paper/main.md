...
| Cost | Primary: confirmation GPU-sec $C_{\mathrm{pass}}$ on balanced MATH-500 subsets with `max_num_seqs=8` (\$1.50/A100-h scenario). Historical: 65 tok/s token proxy. First unconstrained serving run is provenance only. Not a unique “true Pareto optimum.” Pooled nondominated: Qwen FP8 and Qwen GPTQ-4. |
