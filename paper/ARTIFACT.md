...
**ArXiv upload zip:** `paper/arxiv_source.zip` — rebuilt 2026-08-18 from current `main.tex` (75,970 B) + `references.bib` (7,650 B) + `main.bbl` (6,613 B) after the title/author update. Do not upload a zip from before this rebuild.
