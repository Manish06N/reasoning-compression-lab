...
# Do not delete zero-byte *.lock files: flock lockfiles are zero bytes by design.
# Deleting them while another job holds the inode breaks exclusive locking (manifest races).
